...
public class InMemoryCampaignRepositoryTestImpl implements CampaignRepository {
    ...
    @Override
    public Campaign getOne(Long aLong) {
        return null;
    }

    @Override
    public Campaign getById(Long aLong) {
        return null;
    }

    @Override
    public Campaign getReferenceById(Long aLong) {
        return null;
    }
    ...
    public <S extends Campaign> S save(S entity) {
        campaigns.put(entity.getId(), entity);
        return entity;
    }
    ...
    @Override
    public List<Campaign> findAllById(Iterable<Long> longs) {
        return null;
    }
